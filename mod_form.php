...
/**
 * Defines the mdposter instance settings form
 *
 * @copyright 2015 David Mudrak <david@moodle.com>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_mdposter_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        // Add the mdposter name field.
        $mform->addElement('text', 'name', get_string('mdpostername', 'mod_mdposter'), array('size' => '64'));
        ...
        $mform->addElement('advcheckbox', 'overwrite', get_string('overwrite', 'mod_mdposter'), '', array('group' => 1), array(0, 1));

        // Metadata Field #1
        $mform->addElement('header', 'meta_label_1', get_string('meta_label_1', 'mod_mdposter'));
        // $mform->setExpanded('meta_label_1');
        $mform->addElement('text', 'meta1', get_string('meta_title', 'mod_mdposter'), array('size' => '64'));
        $mform->setType('meta1', PARAM_TEXT);
        $mform->addRule('meta1', get_string('maximumchars', 'core', 255), 'maxlength', 255, 'client');
        //
        $mform->addElement('text', 'meta_value1', get_string('meta_value', 'mod_mdposter'), array('size' => '64'));
        $mform->setType('meta_value1', PARAM_TEXT);
        $mform->addRule('meta_value1', get_string('maximumchars', 'core', 255), 'maxlength', 255, 'client');


         // Metadata Field #2
        $mform->addElement('header', 'meta_label_2', get_string('meta_label_2', 'mod_mdposter'));
        // $mform->setExpanded('meta_label_2');
        $mform->addElement('text', 'meta2', get_string('meta_title', 'mod_mdposter'), array('size' => '64'));
        $mform->setType('meta2', PARAM_TEXT);
        $mform->addRule('meta2', get_string('maximumchars', 'core', 255), 'maxlength', 255, 'client');
        //
        $mform->addElement('text', 'meta_value2', get_string('meta_value', 'mod_mdposter'), array('size' => '64'));
        $mform->setType('meta_value2', PARAM_TEXT);
        $mform->addRule('meta_value2', get_string('maximumchars', 'core', 255), 'maxlength', 255, 'client');


        // Metadata Field #3
        $mform->addElement('header', 'meta_label_3', get_string('meta_label_3', 'mod_mdposter'));
        // $mform->setExpanded('meta_label_3');
        $mform->addElement('text', 'meta3', get_string('meta_title', 'mod_mdposter'), array('size' => '64'));
        $mform->setType('meta3', PARAM_TEXT);
        $mform->addRule('meta3', get_string('maximumchars', 'core', 255), 'maxlength', 255, 'client');
        //
        $mform->addElement('text', 'meta_value3', get_string('meta_value', 'mod_mdposter'), array('size' => '64'));
        $mform->setType('meta_value3', PARAM_TEXT);
        $mform->addRule('meta_value3', get_string('maximumchars', 'core', 255), 'maxlength', 255, 'client');


        // Metadata Field #4
        $mform->addElement('header', 'meta_label_4', get_string('meta_label_4', 'mod_mdposter'));
        // $mform->setExpanded('meta_label_4');
        $mform->addElement('text', 'meta4', get_string('meta_title', 'mod_mdposter'), array('size' => '64'));
        $mform->setType('meta4', PARAM_TEXT);
        $mform->addRule('meta4', get_string('maximumchars', 'core', 255), 'maxlength', 255, 'client');
        //
        $mform->addElement('text', 'meta_value4', get_string('meta_value', 'mod_mdposter'), array('size' => '64'));
        $mform->setType('meta_value4', PARAM_TEXT);
        $mform->addRule('meta_value4', get_string('maximumchars', 'core', 255), 'maxlength', 255, 'client');


        // Metadata Field #5
        $mform->addElement('header', 'meta_label_5', get_string('meta_label_5', 'mod_mdposter'));
        // $mform->setExpanded('meta_label_5');
        $mform->addElement('text', 'meta5', get_string('meta_title', 'mod_mdposter'), array('size' => '64'));
        $mform->setType('meta5', PARAM_TEXT);
        $mform->addRule('meta5', get_string('maximumchars', 'core', 255), 'maxlength', 255, 'client');
        //
        $mform->addElement('text', 'meta_value5', get_string('meta_value', 'mod_mdposter'), array('size' => '64'));
        $mform->setType('meta_value5', PARAM_TEXT);
        $mform->addRule('meta_value5', get_string('maximumchars', 'core', 255), 'maxlength', 255, 'client');


        // Metadata Field #6
        $mform->addElement('header', 'meta_label_6', get_string('meta_label_6', 'mod_mdposter'));
        // $mform->setExpanded('meta_label_6');
        $mform->addElement('text', 'meta6', get_string('meta_title', 'mod_mdposter'), array('size' => '64'));
        $mform->setType('meta6', PARAM_TEXT);
        $mform->addRule('meta6', get_string('maximumchars', 'core', 255), 'maxlength', 255, 'client');
        //
        $mform->addElement('text', 'meta_value6', get_string('meta_value', 'mod_mdposter'), array('size' => '64'));
        $mform->setType('meta_value6', PARAM_TEXT);
        $mform->addRule('meta_value6', get_string('maximumchars', 'core', 255), 'maxlength', 255, 'client');


        // Metadata Field #6
        $mform->addElement('header', 'meta_label_7', get_string('meta_label_7', 'mod_mdposter'));
        // $mform->setExpanded('meta_label_6');
        $mform->addElement('text', 'meta7', get_string('meta_title', 'mod_mdposter'), array('size' => '64'));
        $mform->setType('meta7', PARAM_TEXT);
        $mform->addRule('meta7', get_string('maximumchars', 'core', 255), 'maxlength', 255, 'client');
        //
        $mform->addElement('text', 'meta_value7', get_string('meta_value', 'mod_mdposter'), array('size' => '64'));
        ...
        //========================   FILE PIKCER ==========================================
        $mform->addElement('header', 'meta_label_file', get_string('meta_label_file', 'mod_mdposter'));
        ...
        $mform->addElement('filemanager', 'files', get_string('metadatafile','mdposter'), null, $filemanager_options);
        //========================   FILE PIKCER ==========================================

        // Add checkbox to indicate whether to autopopulate the previous fields from children block objects
        $mform->addElement('advcheckbox', 'autopopulate', get_string('autopopulate', 'mdposter'), '', array('group' => 1), array(0, 1));


        // Add the show name at the view page field.
        $mform->addElement('advcheckbox', 'shownameview', get_string('shownameview', 'mod_mdposter'));
        $mform->addHelpButton('shownameview', 'shownameview', 'mod_mdposter');
        ...
        $mform->addElement('advcheckbox', 'showdescriptionview', get_string('showdescriptionview', 'mod_mdposter'));
        $mform->addHelpButton('showdescriptionview', 'showdescriptionview', 'mod_mdposter');
    ...
    function data_preprocessing(&$default_values) {
        if ($this->current->instance and !$this->current->tobemigrated) {
            ...
            file_prepare_draft_area($draftitemid, $this->context->id, 'mod_mdposter', 'content', 0, array('subdirs'=>true));
